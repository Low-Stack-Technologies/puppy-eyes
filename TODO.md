...
- [x] **RFC-Compliant DNS Limits**: Enforce the strict RFC 7208 limit of 10 DNS-interactive mechanisms per SPF check to prevent Denial of Service attacks. This requires a counter that persists across nested `include` and `redirect` mechanisms.
